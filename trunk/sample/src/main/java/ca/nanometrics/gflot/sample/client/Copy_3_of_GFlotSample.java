...
public class Copy_3_of_GFlotSample implements EntryPoint {
...
//        DOM.setElementProperty( element, "id", "gflot" );
...
//		handler1.add(new DataPoint(12, -6.6));
		...
		// create the plot
		SimplePlot plot = new SimplePlot(/*element,*/ model, plotOptions);
